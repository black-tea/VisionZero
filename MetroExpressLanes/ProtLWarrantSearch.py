...
SigInt = "SigIntwithin3miBuffer" # This is a feature class containing all signalized intersections in the City
Collisions = "Parties2013DriversUorLTurn" # This is the parties table that has been joined to the collisions table, which includes the unique intersection ID
